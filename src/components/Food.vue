            ...
            <div class="row gx-4 gx-lg-2 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
              <div class="col mb-2">
                <div class="card h-100">
                  <!-- Product image-->
                  <img class="card-img-top" src="https://cdn.dominos.co.kr/admin/upload/goods/20200508_780B32i8.jpg" width="250px" height="200px" alt="...">
                  <!-- Product details-->
                  <div class="card-body p-4">
                    <div class="text-center">
                      <!-- Product name-->
                      <h5 class="fw-bolder">맛있는 핏자</h5>
                    </div>
                  </div>
                  <!-- Product actions-->
                  <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto">좋아요</a></div>
                  </div>
                </div>
              </div>
              <div class="col mb-2">
